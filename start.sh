...
echo "  🖥️ Frontend (Local):   http://localhost:5173"
[ -n "$LAN_IP" ] && echo "  📱 Frontend (Red LAN): http://${LAN_IP}:5173"
echo "  📖 Swagger UI:         http://localhost:8080/swagger-ui.html"
[ -n "$LAN_IP" ] && echo "  📖 Swagger UI (LAN):   http://${LAN_IP}:5173/swagger-ui.html"
echo "  ⚙️ Backend API:        http://localhost:8080"
echo "  🗄️ PostgreSQL:         127.0.0.1:5432 (turnos_db)"
echo ""
